...
//        UINavigationBar.appearance().barTintColor = UIColor.rgb(red: 230, green: 32, blue: 31)
        UINavigationBar.appearance().barTintColor = UIColor.rgb(red: 30, green: 215, blue: 96)
        ...
        statusBarBackgroundView.backgroundColor = UIColor.rgb (red:34, green:139, blue:34)
